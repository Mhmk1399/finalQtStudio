  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-800">تحلیل پروژه‌ها</h1>
          <p className="text-gray-600 mt-1">نمای کلی از وضعیت پروژه‌ها و درآمد</p>
        </div>
        <button
          onClick={fetchProjects}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-6">
        <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg p-6 text-white relative">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-blue-100 text-sm">کل پروژه‌ها</p>
              <p className="text-xl font-bold">{stats.totalProjects.toLocaleString('fa-IR')}</p>
            </div>
            <div className="bg-blue-400 bg-opacity-30 rounded-full p-3 absolute top-1 left-1">
        ...
        <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-lg p-6 text-white relative">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-green-100 text-sm">پروژه‌های فعال</p>
              <p className="text-xl font-bold">{stats.activeProjects.toLocaleString('fa-IR')}</p>
            </div>
            <div className="bg-green-400 bg-opacity-30 rounded-full p-3 absolute top-1 left-1">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="bg-gradient-to-r from-purple-500 to-purple-600 rounded-lg p-6 text-white relative">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-purple-100 text-sm">پروژه‌های تکمیل شده</p>
              <p className="text-xl font-bold">{stats.completedProjects.toLocaleString('fa-IR')}</p>
            </div>
            <div className="bg-purple-400 bg-opacity-30 rounded-full p-3 absolute top-1 left-1">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="bg-gradient-to-r from-emerald-500 to-emerald-600 rounded-lg p-6 text-white relative">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-emerald-100 text-sm">کل درآمد</p>
              <p className="text-xl font-bold">{stats.totalRevenue.toLocaleString('fa-IR')}</p>
            </div>
            <div className="bg-emerald-400 bg-opacity-30 rounded-full p-3 absolute top-1 left-1">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="bg-gradient-to-r from-orange-500 to-orange-600 relative rounded-lg p-6 text-white">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-orange-100 text-sm">میانگین ارزش پروژه</p>
              <p className="text-xl font-bold">{Math.round(stats.avgProjectValue).toLocaleString('fa-IR')}</p>
            </div>
            <div className="bg-orange-400 bg-opacity-30 rounded-full p-3 absolute top-1 left-1">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="bg-gradient-to-r from-red-500 to-red-600 rounded-lg p-6 text-white relative">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-red-100 text-sm">کل تخفیف</p>
              <p className="text-xl font-bold">{stats.totalDiscount.toLocaleString('fa-IR')}</p>
            </div>
            <div className="bg-red-400 bg-opacity-30 rounded-full p-3 absolute top-1 left-1">
              <svg className="w-6 h-6 " fill="none" stroke="currentColor" viewBox="0 0 24 24">

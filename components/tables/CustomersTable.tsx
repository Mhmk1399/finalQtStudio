  ...
  const handleEdit = (customer: any) => {
    const config: ModalConfig = {
      ...
      fields: [
        ...
        { key: "phoneNumber", label: "شماره تلفن", type: "tel", required: true },
        { key: "businessName", label: "نام کسب‌وکار", type: "text", required: true },
        { 
          key: "businessScale", 
          label: "مقیاس کسب‌وکار", 
          type: "select",
      ...
      onError: (error) => {
        ...
        alert("خطا در به‌روزرسانی اطلاعات: " + error);
      },
      onClose: () => setShowModal(false),
